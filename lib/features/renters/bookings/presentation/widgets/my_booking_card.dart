...
class MyBookingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ownerName = apartment?.ownerName ?? '';
    final ownerPhone = apartment?.ownerPhone ?? '';
    final owner = ownerName.isNotEmpty
        ? ownerName
        : (ownerPhone.isNotEmpty ? ownerPhone : '-');
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _InfoRow(icon: Iconsax.user_tag, label: 'Owner', value: owner),
                const SizedBox(height: 6),
                _InfoRow(
