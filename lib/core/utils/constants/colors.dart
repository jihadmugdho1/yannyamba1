...
class AppColors {
  ...
  static const Gradient linearGradient = LinearGradient(
    ...
    colors: [Color(0xFFFFF9AE), Color(0xFFFAD0C4), Color(0xFFFAD0C4)],
  );
  // Text Colors
  ...
  // App Colors
  static const Color appBarColor = Color(0xEA3561FF);
  static const Color hintColor = Color(0xFF818181);
  static const Color typeColor = Color(0xFF555A6C);
  static const Color wpGreen = Color(0xFF29A71A);
  static const Color primaryBlue = Color(0xFF3561FF);

  //Text Colors
  static const Color textColor = Color(0xFF282828);
  static const Color textColor2 = Color(0xFF686868);
  static const Color greenColor = Color(0xFF29A71A);
}
