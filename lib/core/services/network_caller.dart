  ...
  ResponseData _handleResponse(Response response) {
    ...
    if (response.statusCode >= 200 && response.statusCode < 300) {
      ...
      return ResponseData(
        ...
        statusCode: response.statusCode,
        responseData: decoded,
        errorMessage: _extractErrorMessages(decoded),
      );
      ...
      return ResponseData(
        ...
        statusCode: 500,
        responseData: '',
        errorMessage: _readMessage(decoded, fallback: 'Server error occurred'),
      );
    } else {
      return ResponseData(
        isSuccess: false,
        statusCode: response.statusCode,
        responseData: decoded,
        errorMessage: _readMessage(decoded),
      );
    }
  }

  String _extractErrorMessages(dynamic decoded) {
    if (decoded is Map<String, dynamic>) {
      final errorSources = decoded['errorSources'];
